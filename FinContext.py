"""FinContext.py v1.0.0 - Financial Context Injection Layer
Converts external call metadata into normalized financial context. No audio/transcript dependency."""

import json, sys
from typing import Dict, Optional
from datetime import datetime, timezone

VERSION, ARTIFACT_TYPE = "1.0.0", "financial_context"
