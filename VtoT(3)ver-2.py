...
# Try to import pyannote for diarization
...
# Hugging Face token for pyannote (required for model access)
# Users need to accept terms at https://huggingface.co/pyannote/speaker-diarization-3.1
...
class HybridTranscriptionAgent:
    ...
    def _whisper(self, wav: str) -> Dict:
        ...
        try:
            ...
            result = self.whisper_model.transcribe(audio, fp16=False, verbose=False)
